...
class DssmLstmTrainner:

    def __init__(self, vocab_file="vocab.json"):
        self.model_dir = "dssm_lstm"
        ...
        with tf.variable_scope('dssm_lstm_query'):
            self.model = LSTMDSSM(self.vocab_file, self.num_lstm_units, vocab_size)
